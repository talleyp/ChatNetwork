...
def parseargs():
    ...
    parser.add_argument('-s', '--server', default='irc.rizon.net',
                help='dns address of the irc server. default=irc.rizon.net')
    parser.add_argument('-p', '--port', type=int, default=6667,
                help='port number of irc server. deault=6667')
    parser.add_argument('-c', '--channel', default='#destinyecho',
                help='irc channel to join. default=#destinyecho')
